//
//  UxApiResponseParser_SwiftyJSON_Spec.swift
//  NetworkingTests
//
...
class UxApiResponseParser_SwiftyJSON_Spec: QuickSpec {
    override func spec() {
        describe("UxApiResponseParser_SwiftyJSON") {
            var sut: UxAPIResponseParser_SwiftyJSON!

            var response: Response!

            beforeEach {
                sut = UxAPIResponseParser_SwiftyJSON()
            }
